...
import com.constantineqaq.base.entity.vo.response.AuthorizeVO;
import com.constantineqaq.base.filter.JwtAuthenticationFilter;
import com.constantineqaq.base.filter.RequestLogFilter;
import com.constantineqaq.base.service.AccountService;
import com.constantineqaq.base.utils.UserJwtUtil;
...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        log.info("进入了SecurityConfiguration.filterChain");
        return http
    ...
    private void handleProcess(HttpServletRequest request,
        ...
        if(exceptionOrAuthentication instanceof AccessDeniedException exception) {
            ...
            String jwt = userJwtUtil.createJwt(user, account.getUsername(), account.getId());
            if(jwt == null) {
